...
async def delete_document(document_name: str):
    ...
    return {
        "message": f"Dokument '{document_name}' erfolgreich gelöscht"
    }
...
async def upload_document(file: UploadFile = File(...)):
    ...
    try:
        ...
        response_message = f"Dokument '{file.filename}' erfolgreich verarbeitet und zur Vektordatenbank hinzugefügt"
